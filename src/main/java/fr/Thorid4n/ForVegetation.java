...
import fr.Thorid4n.item.ModCreativeModTabs;
...
@Mod(ForVegetation.MOD_ID)
public class ForVegetation {
    public static final String MOD_ID = "forvegetation";
    public static final Logger LOGGER = LogUtils.getLogger();

    public ForVegetation() {
